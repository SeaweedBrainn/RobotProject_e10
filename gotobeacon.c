...
// Global Variables
int freq, ambient_level, slow_level, stop_level, expose_time, steer_sensitivity, forward_speed, slow_speed, spin_speed, frontValue, backValue;
...
task main(){
	...
	ambient_level = 250; // used in 'move'
	...
	while(state == 1){
		...
		lmtSwitch = SensorValue[limitSwitch];
